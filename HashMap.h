...
#ifndef RGBANDYUV_HASHMAP_H
#define RGBANDYUV_HASHMAP_H
...
//增加一条映射
void myHashMapPutData(MyHashMap *const map, void *const key, int const value);

//通过key得到数据，如果没有数据则返回null
int myHashMapGetDataByKey(MyHashMap *const map, void *const key);
